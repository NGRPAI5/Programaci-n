...
while continuar==True:
    menu=int(input("Escoja que desea de menú o ponga 0 si no desea nada: "))
    acompanamineto=int(input("Escoja que desea de acompañamiento o ponga 0 si no desea nada: "))
    bebidas=int(input("Escoja que desea de bebidos o ponga 0 si no desea nada: "))
    pedidos+=1
